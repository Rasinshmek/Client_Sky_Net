...
public class Settings extends javax.swing.JFrame {
    ...
    ArrayList<JSlider> s = new ArrayList<>();
    ...
    public Settings() {
        ...
        try {
            ...
            out.writeUTF("HARD: GETVARIABLES");
            out.flush();
            String s = in.readUTF();
    ...
    private void parse(String str) {
        ...
        GridLayout layout = new GridLayout(count, 3, 5, 10);
        jPanel1.setLayout(layout);
        for (int i = 0; i < count; i++) {
            String[] key_val = str2[i + 1].split("=");
            JLabel l = new JLabel(key_val[1]);
            l.setSize(20, 20);
            JSlider s = new JSlider(0, 255, Integer.parseInt(key_val[1]));
            JTextField f =new JTextField(key_val[0]);
            f.setSize(150, 20);
